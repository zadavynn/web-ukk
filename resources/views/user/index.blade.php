...
@section('content')
            ...
            <div class="carousel-inner">
                @for ($i = 1; $i <= 10; $i++)
                    <div class="carousel-item {{ $i == 1 ? 'active' : '' }}">
                        <img src="{{ asset('storage/img/background/kegiatan-user-' . $i . ($i == 1 ? '.jpeg' : '.jpg')) }}"
                            class="d-block w-100" style="height:470px; object-fit:cover;">
                    </div>
                @endfor
            </div>
            <button class="carousel-control-prev" type="button" data-bs-target="#carousel10" data-bs-slide="prev"><span
                    class="carousel-control-prev-icon"></span></button>
            <button class="carousel-control-next" type="button" data-bs-target="#carousel10" data-bs-slide="next"><span
    ...
    <div class="container mt-5">
        <div id="heroCarousel" class="carousel slide mb-5 shadow rounded-3 overflow-hidden" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active bg-primary text-white d-flex align-items-center justify-content-center text-center"
                    style="height:220px;">
                    <div>
                ...
                <div class="carousel-item bg-warning text-dark d-flex align-items-center justify-content-center text-center"
                    style="height:220px;">
                    <div>
                ...
                <div class="carousel-item bg-success text-white d-flex align-items-center justify-content-center text-center"
                    style="height:220px;">
                    <div>
                ...
                <div class="col-md-3">
                    <div class="card shadow h-100 border-0 rounded-3">
                        <div class="card-body border-top border-4 border-primary rounded-2">
                            ...
                            <p class="card-text small mb-1"><i class="bi bi-geo-alt text-danger"></i>
                                {{ $kegiatan->lokasi }}</p>
                            <p class="card-text small mb-1"><i class="bi bi-calendar text-success"></i>
    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-6">
                ...
                <p class="text-muted mb-4">Orang-orang hebat yang bekerja di balik layar kegiatan.</p>
                            ...
                            <h2 class="accordion-header" id="heading{{ $loop->index }}">
                                <button class="accordion-button collapsed fw-semibold" type="button"
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <small
                                            class="text-muted fw-normal">{{ \Illuminate\Support\Str::headline($panitia->jabatan) }}</small>
                                    </div>
                                </button>
                            </h2>
                            <div id="panitia{{ $loop->index }}" class="accordion-collapse collapse"
                                data-bs-parent="#panitiaAccordion">
                                <div class="accordion-body text-muted small"><i
                                        class="bi bi-quote me-2"></i>“{{ ucfirst(strtolower($panitia->quotes)) }}”</div>
                            </div>
                        </div>
                    @endforeach
                </div>
            ...
            <div class="col-lg-6">
                ...
                <p class="text-muted mb-4">Pihak yang mendukung terselenggaranya kegiatan ini.</p>
                <div class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="card border-0 shadow rounded-4 h-100">
                                <div
                                    ...
                                    <div>
                                        <h6 class="fw-semibold mb-0">{{ Str::title(strtolower($sponsor->nama_sponsor)) }}
                                        </h6>
                                    </div>
