    ...
    <div class="container-fluid">
        <div class="row" style="margin-top:56px;">
            ...
            <aside
                ...
                <div class="p-3 mt-auto"> <a href="{{ route('admin.logout') }}"
                        class="btn btn-outline-danger w-100 d-flex align-items-center justify-content-center"> <i
                            class="bi bi-box-arrow-right me-2"></i>Keluar </a> </div>
            </aside>

            <!-- CONTENT -->
            <main class="col-md-9 col-lg-10 ms-auto p-4"> @yield('content') </main>
        </div>
    </div>
