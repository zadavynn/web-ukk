...
<body class="d-flex flex-column min-vh-100">
    ...
    <aside id="sidebar"
        ...
        <div class="offcanvas-body d-flex flex-column p-0 h-100">
            <ul class="list-group list-group-flush mt-3 me-3 flex-grow-1">
                <li class="list-group-item bg-dark border-0 p-0 mb-2">
                    <a href="{{ route('admin.dashboard') }}" class="text-white text-decoration-none d-block py-2 px-3">
                        <i class="bi bi-house me-2"></i>Dashboard
                    </a>
                </li>
                <li class="list-group-item bg-dark border-0 p-0 mb-2">
                    <a href="{{ route('kegiatan.index') }}" class="text-white text-decoration-none d-block py-2 px-3">
                        <i class="bi bi-card-list me-2"></i>Kegiatan
                    </a>
                </li>
                <li class="list-group-item bg-dark border-0 p-0 mb-2">
                    <a href="{{ route('panitia.index') }}" class="text-white text-decoration-none d-block py-2 px-3">
                        <i class="bi bi-person-badge me-2"></i>Panitia
                    </a>
                </li>
                <li class="list-group-item bg-dark border-0 p-0 mb-2">
                    <a href="{{ route('absensi.index') }}" class="text-white text-decoration-none d-block py-2 px-3">
                        <i class="bi bi-person-lines-fill me-2"></i>Absensi
                    </a>
                </li>
                <li class="list-group-item bg-dark border-0 p-0 mb-2">
                    <a href="{{ route('sponsor.index') }}" class="text-white text-decoration-none d-block py-2 px-3">
                        <i class="bi bi-cash me-2"></i>Sponsor
                    </a>
                </li>
                <li class="list-group-item bg-dark border-0 p-0 mb-2">
                    <a href="{{ route('catatan.index') }}" class="text-white text-decoration-none d-block py-2 px-3">
