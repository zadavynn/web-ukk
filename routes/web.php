...
Route::middleware(['web'])->group(function () {
    ...
    // absensi 
    Route::get('/absensi', [AbsensiController::class, 'index'])->name('absensi.index'); // menampilkan daftar
    Route::get('/absensi/create', [AbsensiController::class, 'create'])->name('absensi.create'); // menampilkan form
    Route::post('/absensi', [AbsensiController::class, 'store'])->name('absensi.store'); // menyimpan data
    Route::get('/absensi/{id}/edit', [AbsensiController::class, 'edit'])->name('absensi.edit'); // menampilkan form untuk mengedit
    Route::put('/absensi/{id}', [AbsensiController::class, 'update'])->name('absensi.update'); // menyimpan perubahan data
    Route::delete('/absensi/{id}', [AbsensiController::class, 'destroy'])->name('absensi.destroy'); // menghapus
